    ...
    ?>
			...
			<div class="gonggao">
				<div class="bk">
					...
					<?php
	$kw=$_POST['kw'];
	$sql="select * from tbuser where userName like'%$kw%'";
			...
			if($i==0)
				{
					...
					{
						echo "密码:<td height='25' align='center' class='m_td'>".$rows[$i]."</td></a>&nbsp;</a>&nbsp;";
					}
			else
					{
						echo "权限:<td height='25' align='center' class='m_td'>".$rows[$i]."</td>";
					}		
		}
		echo "</tr>";
	}
