...
<table cellpadding="0" cellspacing="0">
   ...
   <tr>
    ...
    ?>
			...
			<input class="changdu" type="text" name="keywords" placeholder="请输入查询名字"/>
			...
			<td width="25%" class="top" align="center">名字</td>
			<td width="20%" class="top" align="center">密码</td>
			<td width="20%" class="top" align="center">权限</td>
			<td width="10%" class="top" align="center">操作</td>
  			</atr>
<?php
	$sqlstr = "select userNameid,userName,userPassword,userLimit
	             from tbuser
		order by userNameid";
	...
	while ($rows = mysqli_fetch_row($result))
	{
		...
		echo "<td class='m_td'><a href='updateEmp.php?action=update&id=".$rows[0]."'>修改</a>
		      /<a href=deleteEmp.php?action=del&userNameid=".$rows[0]." onclick = 'return del();'>删除</a></td>";
		echo "</tr>";
	}
?>
</table>
