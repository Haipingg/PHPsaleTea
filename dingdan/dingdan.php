...
<div class="jili">
	...
	<ul >
	<li>
	  <a href="dingdan.php">浏览订单信息</a>			
	</li>
	<br>
	<br>
	<br>
	<li>
	  <a href="addEmp.php">添加订单信息</a>
	</li>
	<br>
	<br>
	<br>
	<li>
	  <a href="../yuangong.php">返回上一级目录</a>
	</li>
	<br>
	<br>
	<br>
...
<table cellpadding="0" cellspacing="0">
   ...
   <tr>
    ...
    ?>
			...
			<input class="changdu" type="text" name="keywords" placeholder="请输入商品id"/>
    		...
    		<td width="10%" class="top" align="center">商品id</td>
    		<td width="10%" class="top" align="center">用户id</td>
    		<td width="10%" class="top" align="center">数量</td>
			<td width="10%" class="top" align="center">金额</td>
			<td width="15%" class="top" align="center">地址</td>
			<td width="10%" class="top" align="center">手机号</td>
   			<td width="15%" class="top" align="center">时间</td>
    		<td width="13%" class="top" align="center">操作</td>
  			</atr>
<?php
	$sqlstr = "select saleNo,CommodityNo,userNameid,TBSaleAmount,TBSaleMoney,salelocation,salerel,saleDate
	             from tbsale
		order by saleNo";
	...
	while ($rows = mysqli_fetch_row($result))
	{
		...
		echo "<td class='m_td'><a href='updateEmp.php?action=update&id=".$rows[0]."'>修改</a>
		      /<a href=deleteEmp.php?action=del&saleNo=".$rows[0]." onclick = 'return del();'>删除</a></td>";
		echo "</tr>";
	}
?>
</table>
