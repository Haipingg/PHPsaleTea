   ...
   <tr>
    ...
    ?>
			...
			<div class="gonggao">
				...
				if (!($_POST['jobname'] and $_POST['missalary'] and $_POST['a'] and $_POST['b'] and $_POST['c'] ) )
				{
  					echo "输入不允许为空。点击<a href='javascript:onclick=history.go(-1)'>这里</a> 返回";
				}else{	
	    			$sqlUpdate = "update  tbsale set TBSaleAmount = '".$_POST['jobname']."', TBSaleMoney= '".$_POST['missalary']."', salelocation= '".$_POST['a']."', salerel= '".$_POST['b']."', saleDate= '".$_POST['c']."'
					where saleNo = ".$_POST['id'];//定义更新语句
	    
	    			$result = mysqli_query($conn,$sqlUpdate);
	    			if ($result)
					{
								echo "<b style='font-size:20px;'>修改成功,点击</b><a href='dingdan.php'><b style='color:red;font-size:20px;'>这里</b></a><b style='font-size:20px;'>查看</b>";
	    			}else{
