   ...
   <tr>
    ...
    ?>
			...
			<div class="gonggao">
				<div class="bk">
					...
					<?php
	$kw=$_POST['kw'];
	$sql="select * from tbsale where saleNo like'%$kw%'";
		...
		while ($rows = mysqli_fetch_row($result))
	{
		...
		for($i = 0; $i < count($rows); $i++)
		{
			if($i==0)
				{
					echo "id:<td height='25' align='center' class='m_td'>".$rows[$i]."</td></a>&nbsp;</a>&nbsp;";
				}
		  	else if($i==1)
					{
						echo "商品id:<td height='25' align='center' class='m_td'>".$rows[$i]."</td></a>&nbsp;</a>&nbsp;";
					}
			else if($i==2)
					{
						echo "用户id:<td height='25' align='center' class='m_td'>".$rows[$i]."</td></a>&nbsp;</a>&nbsp;";
					}
			else if($i==3)
					{
						echo "数量:<td height='25' align='center' class='m_td'>".$rows[$i]."</td></a>&nbsp;</a>&nbsp;";
					}
			else if($i==4)
					{
						echo "金额:<td height='25' align='center' class='m_td'>".$rows[$i]."</td></a>&nbsp;</a>&nbsp;";
					}
			else if($i==5)
					{
						echo "地址:<td height='25' align='center' class='m_td'>".$rows[$i]."</td></a>&nbsp;</a>&nbsp;";
					}
			else if($i==6)
					{
						echo "手机号:<td height='25' align='center' class='m_td'>".$rows[$i]."</td></a>&nbsp;</a>&nbsp;";
					}
			else	
					{
						echo "时间:<td height='25' align='center' class='m_td'>".$rows[$i]."</td>";
					}
		}
		echo "</tr>";
	}
