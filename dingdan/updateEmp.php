...
?>
	...
	<td width="30%" class="c_td">&nbsp;</td>
          ...
          <tr>
		  <td class="c_td">&nbsp;</td>
            <td align="right" valign="middle" class="c_td">数量：</td>
            <td align="center" valign="middle" class="c_td">
                <input type="text" name="jobname" value="<?php echo $rows[3] ?>"></td>
		<td class="c_td">&nbsp;</td>
          </tr>
          
          <tr>
		  <td class="c_td">&nbsp;</td>
            <td align="right" valign="middle" class="c_td">金额：</td>
            <td align="center" valign="middle" class="c_td">
                <input type="text" name="missalary" value="<?php echo $rows[4] ?>"></td>
		<td class="c_td">&nbsp;</td>
          </tr>
		  ...
		  <td class="c_td">&nbsp;</td>
            ...
            <td align="center" valign="middle" class="c_td">
                <input type="text" name="a" value="<?php echo $rows[5] ?>"></td>
            <td class="c_td">&nbsp;</td>
	</tr>
  	  
	  	  <tr>
		  <td class="c_td">&nbsp;</td>
            <td align="right" valign="middle" class="c_td">手机号：</td>
            <td align="center" valign="middle" class="c_td">
                <input type="text" name="b" value="<?php echo $rows[6] ?>"></td>
            <td class="c_td">&nbsp;</td>
	</tr>
	  	  <tr>
		  <td class="c_td">&nbsp;</td>
            <td align="right" valign="middle" class="c_td">时间：</td>
            <td align="center" valign="middle" class="c_td">
                <input type="text" name="c" value="<?php echo $rows[7] ?>"></td>
            <td class="c_td">&nbsp;</td>
	</tr>
