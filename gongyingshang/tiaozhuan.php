    ...
    ?>
			...
			<div class="gonggao">
				<div class="bk">
					...
					<?php
	$kw=$_POST['kw'];
	$sql="select * from tbsupplier where Spname like'%$kw%'";
			...
			if($i==0)
				{
					...
					{
						echo "企业名字:<td height='25' align='center' class='m_td'>".$rows[$i]."</td></a>&nbsp;</a>&nbsp;";
					}
			else if($i==2)
					{
						echo "供应商姓名:<td height='25' align='center' class='m_td'>".$rows[$i]."</td></a>&nbsp;</a>&nbsp;";
					}
			else if($i==3)
					{
