...
if (!($_POST['jobname'] and $_POST['missalary'] and $_POST['a'] and $_POST['b'] and $_POST['c'] ) )
{
  echo "输入不允许为空。点击<a href='javascript:onclick=history.go(-1)'>这里</a> 返回";
     	...
     	$sqlInsert = "insert into tbsupplier(Spname,Sname,Swc,Sphone,Semail) values('".$_POST['jobname']."','".$_POST['missalary']."','".$_POST['a']."','".$_POST['b']."','".$_POST['c']."')";
	    			$result = mysqli_query($conn,$sqlInsert);
	    		if ($result)
				{
					echo "<b style='font-size:20px;'>添加成功,点击</b><a href='gys.php'><b style='color:red;font-size:20px;'>这里</b></a><b style='font-size:20px;'>查看</b>";
	    		}else{
