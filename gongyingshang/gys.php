...
<div class="jili">
	...
	<ul >
	<li>
	  <a href="gys.php">供应商信息</a>			
	</li>
	<br>
	<br>
	<br>
	<li>
	  <a href="addEmp.php">添加供应商信息</a>
	</li>
	<br>
	<br>
	<br>
...
<table cellpadding="0" cellspacing="0">
   ...
   <tr>
    ...
    ?>
			...
			<input class="changdu" type="text" name="keywords" placeholder="请输入企业名字"/>
			...
			<td width="20%" class="top" align="center">企业名字</td>
			<td width="15%" class="top" align="center">姓名</td>
			<td width="15%" class="top" align="center">微信号</td>
			<td width="15%" class="top" align="center">手机号</td>
			<td width="15%" class="top" align="center">邮箱</td>
			<td width="10%" class="top" align="center">操作</td>
  			</atr>
<?php
	$sqlstr = "select Spid,Spname,Sname,Swc,Sphone,Semail
	             from tbsupplier
		order by Spid";
	...
	while ($rows = mysqli_fetch_row($result))
	{
		...
		echo "<td class='m_td'><a href='updateEmp.php?action=update&id=".$rows[0]."'>修改</a>
		      /<a href=deleteEmp.php?action=del&Spid=".$rows[0]." onclick = 'return del();'>删除</a></td>";
		echo "</tr>";
	}
?>
</table>
