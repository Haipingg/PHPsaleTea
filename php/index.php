...
<script type="text/javascript">	/** 这部分是轮播图的css代码**/
    function nextSlide() {
...
setInterval(nextSlide, 3000)
    ...
    <style type="text/css">/** 将图片放入轮播的容器中**/
    img{
        width: 1300px;
        height: 400px;
		margin: 0px;
...
<div id='boxes'>
	...
	<div id='top'>
		...
		<div id='titlel-small'>欢迎你<?php session_start()?></div>
		<div id='titler'>
...
$star=($page-1)*$psize;
$pstr="select*from tbcommodity limit ".$star.",".$psize;
...
<?php
	...
	?>
	 	<iv class='page'><a href="?page=1>">首页</a></iv>
	 	<div class="page"><a href="?page=<?php echo $page-1?>">上一页</a></div>
<?php
}
	?>
...
<?php
	...
	?>
	<div class="page"><a href="?page=<?php echo $page+1?>">下一页</a></div>
	<div class="page"><a href="?page=<?php echo $pcount?>">尾页</a></div>
<?php
}
	?>
