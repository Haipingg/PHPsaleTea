    ...
    ?>
			...
			<div class="gonggao">
				...
				if (!($_POST['jobname'] and $_POST['missalary'] and $_POST['a'] and $_POST['b'] and $_POST['c'] and $_POST['d']) )
				{
	    			...
	    			$sqlUpdate = "update  tbstaff set Sname = '".$_POST['jobname']."', Ssex= '".$_POST['missalary']."', Ssfz= '".$_POST['a']."', Swc= '".$_POST['b']."', Semail= '".$_POST['c']."', Sphone= '".$_POST['d']."'
					where Sid = ".$_POST['id'];//定义更新语句
	    
	    			$result = mysqli_query($conn,$sqlUpdate);
	    			if ($result)
					{
								echo "<b style='font-size:20px;'>修改成功,点击</b><a href='yguanli.php'><b style='color:red;font-size:20px;'>这里</b></a><b style='font-size:20px;'>查看</b>";
	    			}else{
