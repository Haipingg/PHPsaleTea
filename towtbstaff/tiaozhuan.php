    ...
    ?>
			...
			<div class="gonggao">
				<div class="bk">
					...
					<?php
	$kw=$_POST['kw'];
	$sql="select * from tbstaff where Sname like'%$kw%'";
			...
			if($i==0)
				{
					...
					{
						echo "姓名:<td height='25' align='center' class='m_td'>".$rows[$i]."</td></a>&nbsp;</a>&nbsp;";
					}
			else if($i==2)
					{
						echo "身份证:<td height='25' align='center' class='m_td'>".$rows[$i]."</td></a>&nbsp;</a>&nbsp;";
					}
			else if($i==3)
					{
						echo "微信:<td height='25' align='center' class='m_td'>".$rows[$i]."</td></a>&nbsp;</a>&nbsp;";
					}
			else if($i==4)
					{
						echo "邮箱:<td height='25' align='center' class='m_td'>".$rows[$i]."</td></a>&nbsp;</a>&nbsp;";
					}
			else if($i==5)
					{
						echo "手机:<td height='25' align='center' class='m_td'>".$rows[$i]."</td></a>&nbsp;</a>&nbsp;";
					}
			else
					{
						echo "性别:<td height='25' align='center' class='m_td'>".$rows[$i]."</td>";
					}		
		}
		echo "</tr>";
	}
