...
<table cellpadding="0" cellspacing="0">
   ...
   <tr>
    ...
    ?>
			...
			<input class="changdu" type="text" name="keywords" placeholder="请输入查询内容"/>
    		...
    		<td width="12%" class="top" align="center">名字</td>
    		<td width="10%" class="top" align="center">性别</td>
    		<td width="15%" class="top" align="center">身份证号</td>
			<td width="15%" class="top" align="center">微信号</td>
			<td width="15%" class="top" align="center">邮件</td>
			<td width="10%" class="top" align="center">手机号</td>
    		<td width="18%" class="top" align="center">操作</td>
  			</atr>
<?php
	$sqlstr = "select Sid,Sname,Ssex,Ssfz,Swc,Semail,Sphone
	             from tbstaff
		order by Sid";
	...
	while ($rows = mysqli_fetch_row($result))
	{
		...
		echo "<td class='m_td'><a href='updateEmp.php?action=update&id=".$rows[0]."'>修改</a>
		      /<a href=deleteEmp.php?action=del&Sid=".$rows[0]." onclick = 'return del();'>删除</a></td>";
		echo "</tr>";
	}
?>
</table>
