...
<table cellpadding="0" cellspacing="0">
   ...
   <tr>
    ...
    ?>
			...
			<input class="changdu" type="text" name="keywords" placeholder="请输入商品名称"/>
    		...
    		<td width="12%" class="top" align="center">商品名称</td>
    		<td width="10%" class="top" align="center">价格</td>
    		<td width="15%" class="top" align="center">类型</td>
			<td width="15%" class="top" align="center">图片链接</td>
			<td width="15%" class="top" align="center">介绍</td>
			<td width="10%" class="top" align="center">重量</td>
...
<?php
	...
	while ($rows = mysqli_fetch_row($result))
	{
		...
		echo "<td class='m_td'><a href='updateEmp.php?action=update&id=".$rows[0]."'>修改</a>
		      /<a href=deleteEmp.php?action=del&CommodityNo=".$rows[0]." onclick = 'return del();'>删除</a></td>";
		echo "</tr>";
	}
?>
</table>
