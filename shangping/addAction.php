...
<table cellpadding="0" cellspacing="0">
   ...
   <tr>
    ...
    ?>
			...
			<div class="gonggao">
 				<?php
				if (!($_POST['jobname'] and $_POST['b'] and $_POST['missalary'] and $_POST['c'] and $_POST['d'] and $_POST['e']) )
				{
  					echo "输入不允许为空。点击<a href='javascript:onclick=history.go(-1)'>这里</a> 返回";
				}else{
     				$sqlInsert = "insert into tbcommodity(CommodityName,Commoditymoney,Commoditytype,Commodityimg,Commodityintroduce,Commodityweight) values('".$_POST['jobname']."','".$_POST['b']."','".$_POST['missalary']."','".$_POST['c']."','".$_POST['d']."','".$_POST['e']."')";
	 
	    			$result = mysqli_query($conn,$sqlInsert);
	    		if ($result)
				{
					echo "<b style='font-size:20px;'>添加成功,点击</b><a href='sp.php'><b style='color:red;font-size:20px;'>这里</b></a><b style='font-size:20px;'>查看</b>";
	    		}else{
