    ...
    ?>
			...
			<div class="gonggao">
				<div class="bk">
					...
					<?php
	$kw=$_POST['kw'];
	$sql="select * from tbcommodity where CommodityName like'%$kw%'";
			...
			if($i==0)
				{
					...
					{
						echo "商品名称:<td height='25' align='center' class='m_td'>".$rows[$i]."</td></a>&nbsp;</a>&nbsp;";
					}
			else if($i==2)
					{
						echo "价格:<td height='25' align='center' class='m_td'>".$rows[$i]."</td></a>&nbsp;</a>&nbsp;";
					}
			else if($i==3)
					{
						echo "类型:<td height='25' align='center' class='m_td'>".$rows[$i]."</td></a>&nbsp;</a>&nbsp;";
					}
			
			else if($i==4)
					{
						echo "图片链接:<td height='25' align='center' class='m_td'>".$rows[$i]."</td></a>&nbsp;</a>&nbsp;";
					}
			else if($i==5)
					{
						echo "介绍:<td height='25' align='center' class='m_td'>".$rows[$i]."</td></a>&nbsp;</a>&nbsp;";
					}
			else 
					{
						echo "重量:<td height='25' align='center' class='m_td'>".$rows[$i]."</td>";
					}
		}
		echo "</tr>";
	}
