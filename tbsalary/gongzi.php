...
<div class="jili">
	...
	<ul >
	<li>
	  <a href="gongzi.php">浏览工资信息</a>			
	</li>
	<br>
	<br>
	<br>
	<li>
	  <a href="addEmp.php">添加工资信息</a>
	</li>
	<br>
	<br>
	<br>
...
<table cellpadding="0" cellspacing="0">
   ...
   <tr>
    ...
    ?>
			...
			<input class="changdu" type="text" name="keywords" placeholder="请输入员工id"/>
    		...
    		<td width="10%" class="top" align="center">员工id</td>
    		<td width="20%" class="top" align="center">日期</td>
    		<td width="20%" class="top" align="center">金额</td>
    		<td width="20%" class="top" align="center">操作员姓名</td>
   			 <td width="20%" class="top" align="center">操作</td>
  			</atr>
<?php
	$sqlstr = "select Said,Sid,Sdate,Smoney,Speople
	             from tbsalary
		order by Said";
	...
	while ($rows = mysqli_fetch_row($result))
	{
		...
		echo "<td class='m_td'><a href='updateEmp.php?action=update&id=".$rows[0]."'>修改</a>
		      /<a href=deleteEmp.php?action=del&Said=".$rows[0]." onclick = 'return del();'>删除</a></td>";
		echo "</tr>";
	}
?>
</table>
