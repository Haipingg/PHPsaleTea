    ...
    ?>
			...
			<div class="gonggao">
				<div class="bk">
					...
					<?php
	$kw=$_POST['kw'];
	$sql="select * from tbsalary where Sid like'%$kw%'";
			...
			if($i==0)
				{
					...
					{
						echo "员工id:<td height='25' align='center' class='m_td'>".$rows[$i]."</td></a>&nbsp;</a>&nbsp;";
					}
			else if($i==2)
					{
						echo "时间:<td height='25' align='center' class='m_td'>".$rows[$i]."</td></a>&nbsp;</a>&nbsp;";
					}
			else if($i==3)
					{
					...
					{
						echo "操作员姓名:<td height='25' align='center' class='m_td'>".$rows[$i]."</td>";
					}		
		}
		echo "</tr>";
	}
