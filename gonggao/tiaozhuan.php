    ...
    ?>
			...
			<div class="gonggao">
				<div class="bk">
					...
					<?php
	$kw=$_POST['kw'];
	$sql="select * from gonggao where gonggao like'%$kw%'";
			...
			if($i==0)
				{
					...
					{
						echo "公告:<td height='25' align='center' class='m_td'>".$rows[$i]."</td></a>&nbsp;</a>&nbsp;";
					}
			else
					{
						echo "日期:<td height='25' align='center' class='m_td'>".$rows[$i]."</td>";
					}		
		}
		echo "</tr>";
	}
