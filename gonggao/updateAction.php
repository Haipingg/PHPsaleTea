   ...
   <tr>
    ...
    ?>
			...
			<div class="gonggao">
 				<?php
include_once("conn.php");
if (!($_POST['jobname'] and $_POST['missalary'] ) )
{
  echo "输入不允许为空。点击<a href='javascript:onclick=history.go(-1)'>这里</a> 返回";
}else{	
	    $sqlUpdate = "update  gonggao set gonggao = '".$_POST['jobname']."', riqi= '".$_POST['missalary']."'
		where id = ".$_POST['id'];//定义更新语句
	    
	    			$result = mysqli_query($conn,$sqlUpdate);
	    			if ($result)
					{
								echo "<b style='font-size:20px;'>修改成功,点击</b><a href='gg.php'><b style='color:red;font-size:20px;'>这里</b></a><b style='font-size:20px;'>查看</b>";
	    			}else{
